# pavlusha_1.py - PEREUSTANOVKA + AUTO ENTER
import sys, os, subprocess, time

print("=" * 60)
print("  PAVLUSHA 1 - PEREUSTANOVKA + AUTO ENTER")
print("=" * 60)
...
# STEP 3 - AUTO ENTER через subprocess с stdin
...
if r.status_code == 200:
    ...
    # Запускаем и автоматом шлём Enter в stdin
    ...
    # Читаем вывод и если видим "Enter" — шлём Enter
    for line in process.stdout:
        print(f"  {line.rstrip()}")
        if "Enter" in line and "Нажмите" in line:
            process.stdin.write("\n")
            process.stdin.flush()
            print("  (авто Enter)")
